            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="aboutMe">
                        ...
                        echo '
                        <div class="form-group">
                            <label class="font-weight-bold">Gönderilen Mesaj</label>
                            <textarea name="message" cols="30" rows="10" style="width: 100% !important; border-radius: 8px;" disabled>' . $_POST["message"] . '</textarea>
                        </div>
                        ';
                        ?>
